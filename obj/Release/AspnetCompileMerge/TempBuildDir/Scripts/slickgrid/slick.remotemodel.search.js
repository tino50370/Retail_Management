    ...
    function RemoteModel(url) {
        ...
        function ensureData(from, to) {
            ...
            h_request = setTimeout(function () {
                ...
                req = $.post(_url, { searchexpression: searchstr },
                                onSuccess);
        ...
        function onSuccess(resp) {
            // var x = 'patients =' + resp
            // resp = ;
            var patients = eval(resp);




            var from = 1; // this.fromPage * PAGESIZE,;
            var to = patients.length;
            data.length = patients.length; // parseInt(patients.count);
